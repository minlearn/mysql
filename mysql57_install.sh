...
mysql -uroot -p"$ADMIN_PASS" -e "CREATE USER 'root'@'10.10.10.%' IDENTIFIED WITH $RELEASE_AUTH BY '$ADMIN_PASS'; GRANT ALL PRIVILEGES ON * . * TO 'root'@'10.10.10.%'; FLUSH PRIVILEGES;"
echo "" >~/mysql.creds
